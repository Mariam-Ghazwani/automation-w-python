...
L:"ytp-mdx-manual-pairing-popup-dialog",U:{role:"dialog"},R:[{G:"div",L:"ytp-mdx-manual-pairing-popup-dialog-inner-content",R:[{G:"div",L:"ytp-mdx-manual-pairing-popup-title",Z:"Savienojuma izveide ar televizoru t\u012bmekl\u012b, izmantojot kodu, dr\u012bzum\u0101 vairs neb\u016bs pieejama"},{G:"div",L:"ytp-mdx-manual-pairing-popup-buttons",R:[{G:"button",la:["ytp-button","ytp-mdx-manual-pairing-popup-learn-more"],Z:"Uzziniet vair\u0101k"},{G:"button",la:["ytp-button","ytp-mdx-manual-pairing-popup-ok"],
Z:"Labi"}]}]}]});this.u=new g.jO(this,250);this.learnMoreButton=this.ia("ytp-mdx-manual-pairing-popup-learn-more");this.okButton=this.ia("ytp-mdx-manual-pairing-popup-ok");g.D(this,this.u);this.N(this.learnMoreButton,"click",this.B);this.N(this.okButton,"click",this.C)},P8=function(){g.V.call(this,{G:"div",
L:"ytp-mdx-popup-dialog",U:{role:"dialog"},R:[{G:"div",L:"ytp-mdx-popup-dialog-inner-content",R:[{G:"div",L:"ytp-mdx-popup-title",Z:"Esat izrakst\u012bjies"},{G:"div",L:"ytp-mdx-popup-description",Z:"J\u016bsu skat\u012btie videoklipi var tikt pievienoti televizora skat\u012b\u0161an\u0101s v\u0113sturei un ietekm\u0113t televizor\u0101 pied\u0101v\u0101tos ieteikumus. Lai no t\u0101 izvair\u012btos, atceliet darb\u012bbu un dator\u0101 pierakstieties pakalpojum\u0101 YouTube."},{G:"div",L:"ytp-mdx-privacy-popup-buttons",
R:[{G:"button",la:["ytp-button","ytp-mdx-privacy-popup-cancel"],Z:"Atcelt"},{G:"button",la:["ytp-button","ytp-mdx-privacy-popup-confirm"],Z:"Apstiprin\u0101t"}]}]}]});this.u=new g.jO(this,250);this.cancelButton=this.ia("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.ia("ytp-mdx-privacy-popup-confirm");g.D(this,this.u);this.N(this.cancelButton,"click",this.B);this.N(this.confirmButton,"click",this.C)},Q8=function(a){g.V.call(this,{G:"div",
...
c=g.U(b,128)?g.KL("Rad\u0101s k\u013c\u016bda \u0161\u0101d\u0101 ier\u012bc\u0113: $RECEIVER_NAME",c):b.Gb()||g.U(b,4)?g.KL("Tiek atska\u0146ots \u0161\u0101d\u0101 ier\u012bc\u0113: $RECEIVER_NAME",c):g.KL("Izveidots savienojums ar \u0161\u0101du ier\u012bci: $RECEIVER_NAME",c);a.za("statustext",c);a.u.show()}else a.u.hide()},R8=function(a,b){g.vX.call(this,"Atska\u0146ot \u0161eit:",0,a,b);
...
this.Qh={key:i6(),name:"\u0160aj\u0101 dator\u0101"};this.Kg=null;this.subscriptions=[];this.Tz=this.yb=null;this.Dl=[this.Qh];this.Hk=this.Qh;this.Lc=new g.HM(64);this.oE=0;this.Fe=-1;this.po=null;this.xr=this.Fu=!1;this.Um=this.Ro=null;if(!g.KD(this.player.T())){a=this.player;var b=g.yT(a);b&&(b=b.Pk())&&(b=new R8(a,b),g.D(this,b));b=new Q8(a);g.D(this,b);g.xP(a,b.element,4);this.Ro=new P8;g.D(this,this.Ro);g.xP(a,this.Ro.element,4);g.Q(this.player.T().experiments,"pair_servlet_deprecation_warning_enabled")&&
...
break;case -1:this.ub(new g.HM(64));break;case -1E3:this.ub(new g.HM(128,{errorCode:"mdx.remoteerror",errorMessage:"\u0160is videoklips nav pieejams atska\u0146o\u0161anai, izmantojot t\u0101lvad\u012bbu."}))}a=c8(this.yb).u;var b=this.D;(a||b?a&&b&&a.trackName==b.trackName&&a.languageCode==b.languageCode&&a.languageName==b.languageName&&a.kind==b.kind:1)||(this.D=a,mKa(this,a));a=c8(this.yb);-1===a.volume||Math.round(this.J.getVolume())===a.volume&&this.J.isMuted()===a.muted||this.S.isActive()||
this.wI()}else lKa(this)};
...
R8.prototype.Uh=function(a){return"cast-selector-receiver"===a?"Apraide...":this.Dl[a].name};
